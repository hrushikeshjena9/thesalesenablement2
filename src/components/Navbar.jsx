...
//                       <ul
//                         className="absolute left-0 mt-2 bg-[#060B33] text-white shadow-lg w-full z-50 flex justify-around p-4"
//                       >
//                         {(link.name === "Courses" ? courses : services).map((item, idx) => (
//                           <li key={idx} className="px-4 py-2 hover:bg-white cursor-pointer">
//                             <NavLink
//                               to={item.path}
//                               className={({ isActive }) =>
//                                 `block ${
