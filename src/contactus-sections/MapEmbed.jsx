...
const MapSection = () => {
  return (
    <div className="flex container mx-auto px-4 flex-col-reverse sm:flex-row justify-between items-center my-8 space-y-6 sm:space-y-0 sm:space-x-6">
      {/* Left Side Content */}
      <div className="w-full sm:w-1/2 text-center sm:text-left">
        ...
        <p className="text-base text-gray-600 mb-6">
          We are located at The Sales Enablement Company, right at the heart of
          the business district. Feel free to visit us or contact us for further
          information.
        </p>
  ...
  <span className="relative text-white flex items-center">
    <FaCommentDots className="mr-2" /> {/* Icon with margin-right */}
    Contact Us
  </span>
</button>
      </div>
