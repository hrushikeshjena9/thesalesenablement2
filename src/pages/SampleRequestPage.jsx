      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-600">
            ...
            areas for improvement in an existing Sales Team. This assessment was
            built for sales, not adapted. As a result, the findings are
            sales-specific, accurate, and predictive.
          </p>
          <p className="text-lg text-gray-600">
            Download our Free Sample Assessments by filling out the form on the
            right and see for yourself how powerful the insight and analysis
            provided by SEC could be for your organization.
          </p>
        </div>
