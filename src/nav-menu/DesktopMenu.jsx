...
//                 <span
//                   className="hover:bg-gradient-to-r from-[#DB0032] to-[#FA6602] cursor-pointer border-2 border-[#db2100] flex justify-center items-center h-12 w-12 text-center rounded-full"
