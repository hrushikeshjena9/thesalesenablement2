    ...
    <section className=" py-12 container mx-auto px-4">
      <div className=" text-center md:text-left mb-auto">
        <div className="w-full mb-8">
          <h5 className="text-[14px] sm:text-[16px] md:text-[24px]  font-bold bg-gradient-to-r from-[#DB0032] to-[#FA6602] text-transparent bg-clip-text">
            Our Case Studies
          </h5>

          <h2 className="text-[28px] md:text-[36px] sm:text-[28px] font-bold  mt-7 mb-7 w-full sm:w-[700px]">
            Driving Success with Proven <br />
            <span className="bg-gradient-to-r from-[#DB0032] to-[#FA6602] text-transparent bg-clip-text">
              Strategies
            </span>
          </h2>
          <p className="text-base sm:text-lg md:w-[70%] md:leading-[32px] leading-[24px] mt-12 px-4 md:px-0 text-justify">
